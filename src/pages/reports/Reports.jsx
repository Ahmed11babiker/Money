      ...
      <div ref={reportRef} className="bg-white p-6 shadow rounded">
        ...
        {filters ? (
          <div className="mb-4 text-gray-700">
            <p>الفترة: من {filters.dateRange.startDate} إلى {filters.dateRange.endDate}</p>
            <p>الفرع: {filters.branch}</p>
            <p>المركز: {filters.center}</p>
          </div>
        ) : (
          <p className="text-gray-500 mb-4">يرجى تطبيق الفلاتر لعرض التقارير.</p>
        )}

        <div className="mt-6">
          <h3 className="text-lg font-semibold mb-2">📈 الإيرادات الشهرية (مخطط خطي)</h3>
